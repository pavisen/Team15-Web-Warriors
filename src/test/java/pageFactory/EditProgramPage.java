...
public class EditProgramPage {
    ...
    ////////////////WebElements for Background Login///////////////
    @FindBy(id="username") WebElement username;
	@FindBy(id="password")WebElement password;
	@FindBy(id="login")WebElement loginbtn;
    
    //////////////WebElements for Edit//////////////////////
    ...
    @FindBy(xpath="//table//thead//th[2][@class='p-sortable-column p-highlight']") WebElement ProgNameSortIcon;
...
//    }
   ...
   public void ProgNameSort() {
	   ProgNameSortIcon.click();
   }
}
