...
public class EditProgramSteps {
   ...
   ////Background Statements from feature file////////////
   ...
   public void admin_gives_the_correct_lms_portal_url() {
   	ep.enterUsername(ConfigReader.userName());
   	//lg.enterPassword("LmsHackathon@2024");
   	ep.enterPassword(ConfigReader.passWord());
   	ep.clickLogin();   
   }
   @Then("Admin should land on the login page_1")
